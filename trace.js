...
function traceMethod(targetClassMethod)
{
	...
	send(hook[targetMethod].overloads)
...
setTimeout(function() { // avoid java.lang.ClassNotFoundException
	...
	Java.perform(function() {
		...
		// trace("com.bytedance.ies.weboffline.IESOfflineCache.shouldInterceptRequest");
		trace("com.meitu.secret.SigEntity.generatorSigWithFinal");
		// trace("java.security.MessageDigest.digest");
		// trace("java.net.URLEncoder.encode");
		// trace("org.json.JSONObject.put");
		// trace("org.json.JSONObject.put");
		// trace("okhttp3.RequestBody.create");
		// trace("retrofit2.Retrofit$Builder.build");
		// trace("com.tencent.weseevideo.common.report.g$u.g");
